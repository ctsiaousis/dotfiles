...
awful.util.tagnames = { "WEB", "TERM", "DIR", "MED", "tmp" }
...
globalkeys = my_table.join(
    ...
    end,{description = "toggle titlebars", group = "awesome"}),
    --]]
    ...
    awful.key({modkey, "Shift"}, "t", function() awful.spawn("urxvt -e ranger")end,
    		{description = "run thunar, Gfm.", group = "launcher"}),
    -- Default
    --[[ Menubar
    ...
    awful.key({ modkey }, "d", function ()
            os.execute(string.format("dmenu_run -i -fn 'Monospace' -nb '#292d3e' -nf '#fea63c' -sb '%s' -sf '%s'",
